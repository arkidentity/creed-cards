// Deck 4 — Creed Cards (Fulfilled). 50 fulfillment-schema cards, ids 1-50.
// Source of record: DECK4-FULFILLED-CARDS.md (roster/schema: DECK4-FULFILLED.md).
...
export interface FulfillmentCard {
  ...
  deckId: number;
  category: string;
  categorySlug: string; // "prophecy" | "feasts" | "persons" | "objects" | "events"
  kind: "prophecy" | "type";
  ...
  otText: string;
  otRef: string;
  centuriesBefore: string; // "" for undatable types
  ntText: string;
  ntRef: string;
  significance: string; // replaces `definition`
  reflection: string;
